...
| 浮点数加法 | 可能产生`±∞`或`NaN` |  满足  |  不满足，可能舍入<br>`(3.14+1e10)-1e10 = 0`<br>`3.14+(1e10-1e10) = 3.14`   |   0    |     满足，`a ≧ b ⇒ a+c ≧ b+c`     |
| 浮点数乘法 | 可能产生`±∞`或`NaN` |  满足  | 不满足，可能舍入<br>`(1e20*1e20)*1e-20 = +∞`<br>`1e20*(1e20*1e-20) = 1e20` |   1    | 满足，`a ≧ b & c ≧ 0 ⇒ a*c ≧ b*c` |
